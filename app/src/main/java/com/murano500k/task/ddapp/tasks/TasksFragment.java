...
public class TasksFragment extends Fragment{/* implements TasksContract.View {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        swipeRefreshLayout.setOnRefreshListener(() -> mPresenter.loadStudents(false));
    ...
    *//**
    ...
    TaskItemListener mItemListener = new TaskItemListener() {
        ...
        public void onTaskClick(Task clickedTask) {
            mPresenter.openStudentDetails(clickedTask);
        }
    ...
    @Override
    public void showStudents(List<Task> students) {
    ...
    @Override
    public void showStudentDetailsUi(String studentId) {
